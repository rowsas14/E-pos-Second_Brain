<!--
meta:
  title: Receipts / Receipt Delivery / Changelog
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [receipts, receipt-delivery, changelog]
-->
> Hub: [[10-modules/receipts/features/receipt-delivery/overview]]

# Receipt Delivery - Changelog

## Purpose
This file records feature-level change history for **Receipt Delivery**.
