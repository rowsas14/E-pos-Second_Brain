<!--
meta:
  title: Identity & Access / Outlet Assignments / Overview
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [identity-access, outlet-assignments, overview]
-->
# Outlet Assignments

## Purpose
Assignment of staff users to outlet-scoped roles, postings, and primary outlet context.
...
1. [[10-modules/identity-access/features/outlet-assignments/overview]]
2. [[business-rules]]
3. [[data-model]]
4. [[application]]
5. [[api]]
