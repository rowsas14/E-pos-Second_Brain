...
## Purpose
This file defines input, business, and workflow validations for **Brands**.

## Input and business validations
- name required
- code optional but unique within tenant
- same-tenant assignment when linked to products
