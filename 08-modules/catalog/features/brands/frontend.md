...
## Purpose
This file explains frontend behavior and UI integration expectations for **Brands**.

## Main frontend surfaces
- tenant-admin catalog settings or master-data screens
- brand selector in product maintenance
- brand filters in storefront and back-office search
