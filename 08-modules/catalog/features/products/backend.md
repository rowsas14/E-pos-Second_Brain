<!--
meta:
  title: Catalog / Products / Backend
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-18
  tags: [catalog, products, backend]
-->
...
## Purpose
This file explains backend implementation expectations for **Products**.
...
- Product aggregate in catalog domain
- application service for create/update/activate/archive
- read models for admin list, POS quick lookup, and storefront list
