...
## Purpose
This file explains frontend behavior and UI integration expectations for **Attributes**.

## Main frontend surfaces
- attribute master screen
- attribute-value management UI
- category setup mapping UI
- variant builder or product maintenance form
