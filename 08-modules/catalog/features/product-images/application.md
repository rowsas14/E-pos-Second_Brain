...
## Purpose
This file explains how the `Application` layer should orchestrate the **Product Images** feature.

## Primary use cases
- register uploaded image metadata
- mark primary image
- reorder images
- remove or replace image records
