...
## Purpose
This file defines role and permission expectations for **Suppliers**.

## Permission model
- tenant admin, catalog manager, and inventory/procurement roles can maintain suppliers
- cashiers and customers do not manage supplier data
