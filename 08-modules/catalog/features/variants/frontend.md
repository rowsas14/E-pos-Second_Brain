...
## Purpose
This file explains frontend behavior and UI integration expectations for **Variants**.

## Main frontend surfaces
- variant builder in product maintenance
- barcode and SKU display in admin and POS lookup
- variant-specific selection on storefront
