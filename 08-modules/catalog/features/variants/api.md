<!--
meta:
  title: Catalog / Variants / API
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-18
  tags: [catalog, variants, api]
-->
...
## Purpose
This file defines the feature-owned API surface for **Variants**.
...
- `/api/v1/catalog/variants/by-barcode/{barcode}`
