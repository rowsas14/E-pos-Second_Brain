<!--
meta:
  title: Catalog / Variants / Backend
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-18
  tags: [catalog, variants, backend]
-->
...
## Purpose
This file explains backend implementation expectations for **Variants**.
...
- Variant repository with barcode and SKU lookup
- application logic for create/update/activate/archive
- variant readiness checks used by product activation and transaction flows
