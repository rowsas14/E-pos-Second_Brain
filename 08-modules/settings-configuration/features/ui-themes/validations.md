<!--
meta:
  title: Settings & Configuration / UI Themes / Validations
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [settings-configuration, ui-themes, validations]
-->
> Hub: [[10-modules/settings-configuration/features/ui-themes/overview]]

# UI Themes - Validations

## Purpose
This file records input, business, and **workflow** validations for **UI Themes**.

## Validation rules
- reject multiple default themes
- validate token payload shape against supported theme model
