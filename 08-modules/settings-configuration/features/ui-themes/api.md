<!--
meta:
  title: Settings & Configuration / UI Themes / Api
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [settings-configuration, ui-themes, api]
-->
...
## Purpose
This file lists the likely **API** surface and contract concerns for **UI Themes**.

## Endpoints / contract areas
- POST /themes
- PATCH /themes/{themeId}
- POST /themes/{themeId}/set-default
...
Read after [[10-modules/settings-configuration/features/ui-themes/overview]], [[business-rules]], [[data-model]], and [[application]].
