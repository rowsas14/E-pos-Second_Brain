<!--
meta:
  title: Settings & Configuration / Tenant Settings / Data Model
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [settings-configuration, tenant-settings, data-model]
-->
> Hub: [[10-modules/settings-configuration/features/tenant-settings/overview]]

# Tenant Settings - Data Model

## Purpose
This file shows the main **entity**, table, and relationship impact for **Tenant Settings**.
...
Read after [[10-modules/settings-configuration/features/tenant-settings/overview]] and [[business-rules]], then before [[application]] and [[api]].
