<!--
meta:
  title: Sales POS / Hold & Recall Sales / Changelog
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [sales-pos, hold-recall-sales, changelog]
-->
> Hub: [[10-modules/sales-pos/features/hold-recall-sales/overview]]

# Hold & Recall Sales - Changelog

## Purpose
This file records feature-level change history for **Hold & Recall Sales**.
