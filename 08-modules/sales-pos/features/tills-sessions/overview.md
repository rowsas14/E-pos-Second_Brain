<!--
meta:
  title: Sales POS / Tills & Sessions / Overview
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [sales-pos, tills-sessions, overview]
-->
# Tills & Sessions

## Purpose
Cash register terminals and open/close session control for POS operations.
...
1. [[10-modules/sales-pos/features/tills-sessions/overview]]
2. [[business-rules]]
3. [[data-model]]
4. [[application]]
5. [[api]]
