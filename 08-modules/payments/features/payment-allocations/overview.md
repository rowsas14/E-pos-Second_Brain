<!--
meta:
  title: Payments / Payment Allocations / Overview
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [payments, payment-allocations, overview]
-->
# Payment Allocations

## Purpose
Allocation of captured payments to POS sales or E-Commerce orders.
...
1. [[10-modules/payments/features/payment-allocations/overview]]
2. [[business-rules]]
3. [[data-model]]
4. [[application]]
5. [[api]]
