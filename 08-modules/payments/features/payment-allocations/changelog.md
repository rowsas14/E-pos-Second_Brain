<!--
meta:
  title: Payments / Payment Allocations / Changelog
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [payments, payment-allocations, changelog]
-->
> Hub: [[10-modules/payments/features/payment-allocations/overview]]

# Payment Allocations - Changelog

## Purpose
This file records feature-level change history for **Payment Allocations**.
