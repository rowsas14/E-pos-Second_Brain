<!--
meta:
  title: Pricing / Outlet Price Overrides / Bugs
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [pricing, outlet-price-overrides, bugs]
-->
> Hub: [[10-modules/pricing/features/outlet-price-overrides/overview]]

# Outlet Price Overrides - Bugs

## Purpose
This file tracks known issues, recurring defects, and defect patterns for **Outlet Price Overrides**.

## Current watch list
- watch for override leakage into non-outlet channel calculations
