<!--
meta:
  title: Customers / Customer Auth / Changelog
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [customers, customer-auth, changelog]
-->
> Hub: [[10-modules/customers/features/customer-auth/overview]]

# Customer Auth - Changelog

## Purpose
This file records feature-level change history for **Customer Auth**.
