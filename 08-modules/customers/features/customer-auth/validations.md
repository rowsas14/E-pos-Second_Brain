<!--
meta:
  title: Customers / Customer Auth / Validations
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [customers, customer-auth, validations]
-->
> Hub: [[10-modules/customers/features/customer-auth/overview]]

# Customer Auth - Validations

## Purpose
This file records input, business, and **workflow** validations for **Customer Auth**.

## Validation rules
- ensure account tenant_id matches customer tenant_id
- reject duplicate provider identity inside tenant
- enforce email/phone verification rules where required
