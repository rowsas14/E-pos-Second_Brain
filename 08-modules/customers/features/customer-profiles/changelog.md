<!--
meta:
  title: Customers / Customer Profiles / Changelog
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [customers, customer-profiles, changelog]
-->
> Hub: [[10-modules/customers/features/customer-profiles/overview]]

# Customer Profiles - Changelog

## Purpose
This file records feature-level change history for **Customer Profiles**.
