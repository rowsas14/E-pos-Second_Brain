<!--
meta:
  title: Orders E-Commerce / Orders / Overview
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [orders-ecommerce, orders, overview]
-->
# Orders

## Purpose
E-Commerce order creation, status, fulfillment outlet assignment, and immutable order snapshots.
...
1. [[10-modules/orders-ecommerce/features/orders/overview]]
2. [[business-rules]]
3. [[data-model]]
4. [[application]]
5. [[api]]
