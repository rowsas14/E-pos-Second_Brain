<!--
meta:
  title: Orders E-Commerce / Orders / Data Model
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [orders-ecommerce, orders, data-model]
-->
...
## Purpose
This file shows the main **entity**, table, and relationship impact for **Orders**.
...
Read after [[10-modules/orders-ecommerce/features/orders/overview]] and [[business-rules]], then before [[application]] and [[api]].
