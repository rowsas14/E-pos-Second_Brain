<!--
meta:
  title: Orders E-Commerce / Carts / Validations
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [orders-ecommerce, carts, validations]
-->
...
## Purpose
This file records input, business, and **workflow** validations for **Carts**.

## Validation rules
- require guest_token when customer_id is null
- validate variant availability and pricing on item update
