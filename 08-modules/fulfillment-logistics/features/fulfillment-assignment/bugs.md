<!--
meta:
  title: Fulfillment & Logistics / Fulfillment Assignment / Bugs
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [fulfillment-logistics, fulfillment-assignment, bugs]
-->
> Hub: [[10-modules/fulfillment-logistics/features/fulfillment-assignment/overview]]

# Fulfillment Assignment - Bugs

## Purpose
This file tracks known issues, recurring defects, and defect patterns for **Fulfillment Assignment**.

## Current watch list
- watch for order UI showing one assigned outlet while delivery actually uses another after reassignment
