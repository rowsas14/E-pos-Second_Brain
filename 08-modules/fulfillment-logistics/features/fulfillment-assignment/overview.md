<!--
meta:
  title: Fulfillment & Logistics / Fulfillment Assignment / Overview
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [fulfillment-logistics, fulfillment-assignment, overview]
-->
# Fulfillment Assignment

## Purpose
Selection of outlet or fulfillment center that will fulfill an order or delivery.
...
1. [[10-modules/fulfillment-logistics/features/fulfillment-assignment/overview]]
2. [[business-rules]]
3. [[data-model]]
4. [[application]]
5. [[api]]
