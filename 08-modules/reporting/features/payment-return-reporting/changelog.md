<!--
meta:
  title: Reporting / Payment & Return Reporting / Changelog
  owner: Commerce Engineering
  status: active
  last_reviewed: 2026-04-17
  tags: [reporting, payment-return-reporting, changelog]
-->
> Hub: [[10-modules/reporting/features/payment-return-reporting/overview]]

# Payment & Return Reporting - Changelog

## Purpose
This file records feature-level change history for **Payment & Return Reporting**.
